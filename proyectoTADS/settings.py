"""
Django settings for proyectoTADS project.
...
SECRET_KEY = 'django-insecure-h4s-qrw#$xv9d+%_efmzwmc!%biqt^o^og!493g2tc2nr=%uyb'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'inventariosTec/static'),
]
...
ROOT_URLCONF = 'proyectoTADS.urls'
...
WSGI_APPLICATION = 'proyectoTADS.wsgi.application'
